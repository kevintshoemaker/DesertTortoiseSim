...
for(row in 1:nrow(allruns)){   # 
  ...
  # PHI_A
  temp2$PHI_A_base <- thispar$PHI_A$PHI_A_intercept$this
  temp2$PHI_A_p <- thispar$PHI_A$phia.precipeff.mn$this * thisscen_specs$phi.a_pr
